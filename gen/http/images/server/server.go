...
func (s *Server) MethodNames() []string { return images.MethodNames[:] }
...
// MountListHandler configures the mux to serve the "images" service "list"
// endpoint.
func MountListHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/v1/images", f)
}

// NewListHandler creates a HTTP handler which loads the HTTP request and calls
// the "images" service "list" endpoint.
func NewListHandler(
...
// MountCreateHandler configures the mux to serve the "images" service "create"
// endpoint.
