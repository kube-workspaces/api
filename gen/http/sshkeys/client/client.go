...
// Client lists the sshkeys service endpoint HTTP clients.
type Client struct {
...
// NewClient instantiates HTTP clients for all the sshkeys service servers.
func NewClient(
	scheme string,
	host string,
	doer goahttp.Doer,
...
// List returns an endpoint that makes HTTP requests to the sshkeys service
// list server.
func (c *Client) List() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("sshkeys", "list", err)
		}
		return decodeResponse(resp)
	}
}

// Get returns an endpoint that makes HTTP requests to the sshkeys service get
// server.
func (c *Client) Get() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("sshkeys", "get", err)
		}
		return decodeResponse(resp)
	}
}

// Create returns an endpoint that makes HTTP requests to the sshkeys service
// create server.
func (c *Client) Create() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("sshkeys", "create", err)
		}
		return decodeResponse(resp)
	}
}

// Delete returns an endpoint that makes HTTP requests to the sshkeys service
// delete server.
func (c *Client) Delete() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("sshkeys", "delete", err)
		}
		return decodeResponse(resp)
	}
}
