...
// Server lists the sshkeys service endpoint HTTP handlers.
type Server struct {
	Mounts []*MountPoint
	List   http.Handler
	Get    http.Handler
...
// New instantiates HTTP handlers for all the sshkeys service endpoints using
...
func New(
	...
	return &Server{
		Mounts: []*MountPoint{
			{"List", "GET", "/v1/sshkeys"},
			{"Get", "GET", "/v1/sshkeys/{name}"},
			{"Create", "POST", "/v1/sshkeys"},
			{"Delete", "DELETE", "/v1/sshkeys/{name}"},
		},
...
func (s *Server) Service() string { return "sshkeys" }
...
func (s *Server) MethodNames() []string { return sshkeys.MethodNames[:] }

// Mount configures the mux to serve the sshkeys endpoints.
...
// MountListHandler configures the mux to serve the "sshkeys" service "list"
// endpoint.
func MountListHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/v1/sshkeys", f)
}

// NewListHandler creates a HTTP handler which loads the HTTP request and calls
// the "sshkeys" service "list" endpoint.
func NewListHandler(
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		ctx = context.WithValue(ctx, goa.ServiceKey, "sshkeys")
...
// MountGetHandler configures the mux to serve the "sshkeys" service "get"
// endpoint.
...
// MountCreateHandler configures the mux to serve the "sshkeys" service
// "create" endpoint.
...
// MountDeleteHandler configures the mux to serve the "sshkeys" service
// "delete" endpoint.
func MountDeleteHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("DELETE", "/v1/sshkeys/{name}", f)
}

// NewDeleteHandler creates a HTTP handler which loads the HTTP request and
// calls the "sshkeys" service "delete" endpoint.
